...
namespace Thekdar.Migrations
{
    ...
    [Migration("20260428100755_AddMobileAccessToEmployees")]
    partial class AddMobileAccessToEmployees
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EmployeeModel", b =>
                {
                    ...
                    b.Property<DateTime?>("LastMobileLogin")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("MobilePasswordHash")
                        .HasColumnType("text");
                    ...
                    b.ToTable("Employees", null, t =>
                        {
                            t.HasCheckConstraint("CK_Employees_DistinctPhones", "\"Phone2\" IS NULL OR \"Phone1\" <> \"Phone2\"");
                        });
                });
